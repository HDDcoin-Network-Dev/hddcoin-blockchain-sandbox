...
from chia.ssl.create_ssl import get_mozilla_ca_crt  #type:ignore
from clvm.casts import int_to_bytes


HODL_SERVER_BASE = "https://hodl.chia.net"
...
CLIENT_APPVER = chia.__version__
...
class HodlRpcClient:
    ...
    _closing_task: th.Optional[asyncio.Task]  # emulating chia.rpc.rpc_client.RpcClient
    _sslcontext: ssl.SSLContext

    def __init__(self,
                 fingerprint: int,
                 ) -> None:
        import chia.hodl.util  # lazy circref avoidance
        self._vlog_ = chia.hodl.util.vlog

        self.pk, self.sk = chia.hodl.util.getPkSkFromFingerprint(fingerprint)
    ...
    async def _call(self,
        ...
        self.vlog(2, f"Connecting to Chia HODL Server at {api_endpoint}")
