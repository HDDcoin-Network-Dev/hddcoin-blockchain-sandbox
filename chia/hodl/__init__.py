...
import chia.util.default_root
#from chia.types.blockchain_format.sized_bytes import make_sized_bytes
from chia.types.blockchain_format.sized_bytes import SizedBytes

HODL_DIR: pathlib.Path = chia.util.default_root.DEFAULT_ROOT_PATH / "hodl"
